...
hero:
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      link: https://github.com/mearashadowfax/Crawlora
---
...
<CardGrid stagger>
  ...
  <Card title="Werkzeuge & Ausrüstung" icon="seti:eslint">
    Entdecken Sie die vollständige Palette hochwertiger Werkzeuge und Ausrüstungen von Crawlora. Jeder Unterabschnitt bietet detaillierte Spezifikationen, Gebrauchsanweisungen und Wartungstipps.
  </Card>
