export const Icons = {
  ...
  logo: {
    paths: [
      {
        d: "M12 0a12 12 0 00-12 12c0 5.02 3.05 9.26 7.25 11.12-.08-.25-.12-.52-.12-.8 0-.35.04-.69.11-1.03L3.9 16.5A11.96 11.96 0 010 12c0-5.52 4.48-10 10-10a9.95 9.95 0 017.68 3.63l1.25-1.25A12.037 12.037 0 0012 0zM11.95 2.11A10.05 10.05 0 0012 2c4.42 0 8 3.58 8 8 0 3.51-2.11 6.6-5.11 7.8.29.94.45 1.94.45 2.92 0 .56-.05 1.11-.14 1.66C17.43 20.05 20 16.27 20 12c0-4.41-3.59-8-8-8-.82 0-1.62.12-2.39.34l1.34 1.34c1.05.07 2.07.36 2.95.85A6.933 6.933 0 0112 6a6.933 6.933 0 01-4.79 1.85c.88-.49 1.9-.78 2.95-.85L11.95 2.11zM8 11a3 3 0 100 6 3 3 0 000-6zm0 4a1 1 0 110-2 1 1 0 010 2z",
      },
    ],
    class:
      "w-4.5 h-4.5 transition flex-shrink-0 text-neutral-700 duration-300 group-hover:-translate-y-1",
